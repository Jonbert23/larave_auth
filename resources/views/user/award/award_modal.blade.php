<div class="col-sm-6 col-md-3 m-t-30">
    <div id="edit_award" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal m-t-20" action="/award/update" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <a class="latest-message-list">
                            <div class="border-bottom mt-3 position-relative">
                                ...
                                <div class="massage-desc">
                                    ...
                                    <input class="form-control" type="text" placeholder="Enter Course Title" name="award" id="award" style="border:none" value="{{ old('award') }}">
                                </div>
                            </div>
                        </a>
                        @error('award')
...
<div class="col-sm-6 col-md-3 m-t-30">
    <div id="delete_award" class="modal" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
